    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            if cantonese_transcription.strip():  # Check if the transcription is not empty
                ...
                # The text is spoken in the Flask route to avoid speaking twice
                return translated  # Return the translation for JSON response
            else:
                return "No valid transcription received."
